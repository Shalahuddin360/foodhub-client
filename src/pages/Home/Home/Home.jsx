    ...
    return (
        ...
        <Container className=' '>
            <Row className='mb-4'>
                ...
                <h2 className='text-warning text-center text-decoration-underline' >Service</h2>
            <Row xs={1} md={2} lg={2}>
                                 
                <Col lg={4}>
                       
                <Card.Img src={service} alt="Card image" className='shadow-lg bg-body-tertiary rounded' />
                <Card.Img src={images} alt="Card image"className='shadow-lg bg-body-tertiary rounded' />

                </Col>
                 <Col lg={8} className='shadow-lg bg-body-tertiary rounded'>
                 
                   <div className='fw-semibold'>
                   <h2 className='text-warning' >Traditional Service</h2>
                    ...
                    <div className='fw-semibold'>
                    <h2 className='text-warning' >Vip Service</h2>
                        <p>1.Our service boys are responsible for taking orders from customers, serving food and beverages, clearing tables, and ensuring that the restaurant is clean and well-maintained.</p>
            ...
            <Row className='mb-4 mt-4'>
                <Col>
                    <h2 className='text-center text-warning text-decoration-underline'> Online Order For Food Details</h2>
